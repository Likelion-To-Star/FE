        ...
        <div className="signupNext-body">
          <form className="sign-form" onSubmit={handleSignup}>
            ...
            <div className="signNext-container">
              ...
              {errors.petName &&                 <div className="error-container">
            ...
            <div className="signNext-container">
              ...
              {errors.ownerName &&  <div className="error-container">
                  <img src={errorIcon} alt="Warning" className="error-icon" />
            ...
            <div className="signNext-container">
              ...
              {errors.animal &&  <div className="error-container">
                  <img src={errorIcon} alt="Warning" className="error-icon" />
                  <p className="error-message">{errors.animal}</p></div>}
            </div>
